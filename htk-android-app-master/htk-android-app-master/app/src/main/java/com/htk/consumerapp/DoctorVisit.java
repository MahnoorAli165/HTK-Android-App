...
public class DoctorVisit extends FragmentActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, OnMapReadyCallback, LocationListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, GoogleMap.OnMarkerDragListener {

    private EditText appointmentDateText, appointmentTimeText, conditionText, specialText, searchText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.mapD);
    ...
    public void initializViews(){
        ...
        progressBarUpload = findViewById(R.id.progressbarUploadD);
        attachButton = findViewById(R.id.attachBD);
        filenameLabel = findViewById(R.id.filenameD);

        layout = findViewById(R.id.doctorLayout);
        locationLabel = findViewById(R.id.locationLabelD);
        locationButton = findViewById(R.id.locationButtonD);
        confirmLocationButton = findViewById(R.id.confirmLocationButtonD);
        searchText = findViewById(R.id.searchTextD);
        searchIcon = findViewById(R.id.searchIconD);
        center_pin = findViewById(R.id.center_pinD);
    }
        ...
        if (view.getId() == appointmentDateText.getId()){
            ...
            if (isConnectedToInternet()) {
                if (isMapDisplayed) {
                    ...
                    Log.d(TAG, line + "Add Button clicked" + line);
...
//                            mGoogleMap.addMarker(userMarkerOptions);
    ...
    public void bookAppointment(){
        Log.d(TAG, line+"bookAppointment() called"+line);
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.e(TAG, line+"Key: "+reference.getKey()+line);
    ...
    public void getAppointmentCount(){
        ...
        countReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.e(TAG, line+"There are "+ childrenCount +" Doctor Visit appointments already"+line);
                if (childrenCount <10){
                    childrenCount += 1;
                    appointment_id = "htk-doc-00"+ childrenCount;
                }
                else if (childrenCount >=10 && childrenCount <100){
                    childrenCount += 1;
                    appointment_id = "htk-doc-0"+ childrenCount;
                }
                else{
                    childrenCount += 1;
                    appointment_id = "htk-doc-"+ childrenCount;
                }
                Log.e(TAG, line+"Appointment ID: "+ appointment_id+line);
                bookAppointment();
            }
    ...
    public void countUserAppointments(){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.e(TAG, line+"Appointment count: "+appointments_count+line);
                addAppointment();
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.d(TAG, line+"Error adding Appointment added to user: "+databaseError+line);
            }
        });
    }
    ...
    public void addAppointment(){
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.e(TAG, line+"New Appointment count: "+appointments_count+line);
                ...
                reference.child(Uid).child("appointments").child(String.valueOf(appointments_count)).setValue(new_appointment_id).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Log.e(TAG, line+"Appointment added to user: "+Uid+line);
                    }
                });
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e(TAG, line+"Error adding Appointment added to user: "+databaseError+line);
            }
        });
    }
...
//                        Toast.makeText(WellnessTreatments.this, "File uploaded", Toast.LENGTH_SHORT).show();
                        ...
                        Log.e(TAG, "sRef URL: " + sRef.getDownloadUrl().toString());
                        Log.e(TAG, "upload URL: " + upload.getUrl().toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PDF_CODE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (data.getData() != null) {
                ...
                findViewById(R.id.attachment_iconD).setVisibility(View.VISIBLE);
...
//        startActivity(new Intent(DoctorVisit.this, HomeActivity.class));
//    }
