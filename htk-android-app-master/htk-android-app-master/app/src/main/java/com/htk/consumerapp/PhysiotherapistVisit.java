...
public class PhysiotherapistVisit extends AppCompatActivity implements View.OnClickListener, RadioGroup.OnCheckedChangeListener, OnMapReadyCallback, LocationListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, GoogleMap.OnMarkerDragListener {

    private EditText appointmentDateText, appointmentTimeText, specialNoteText, conditionText, searchText;
    ;
    private String appointment_date, appointment_time, checkedRadio, condition, specialnote, customer_id, appointment_id = "";;
    private RadioGroup radioGroup;
    private CheckBox receive_email;
    private Button addButton, locationButton, confirmLocationButton;
    private boolean checked = false;
    private final String TAG = "Physiotherapist Visit";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physiotherapist_visit);
    ...
    public void initializViews(){
        appointmentDateText = findViewById(R.id.appointmentDateP);
        appointmentTimeText = findViewById(R.id.appointmentTimeP);
        radioGroup = findViewById(R.id.physioRadioGroup);
        specialNoteText = findViewById(R.id.physioSpecialText);
        conditionText = findViewById(R.id.physioConditionText);
        receive_email = findViewById(R.id.physioCheckBox);
        addButton = findViewById(R.id.physioButton);
        progressBar = findViewById(R.id.progressBar7);

        progressBarUpload = findViewById(R.id.progressbarUploadP);
        attachButton = findViewById(R.id.attachBP);
        filenameLabel = findViewById(R.id.filenameP);

        layout = findViewById(R.id.physioLayout);
        locationLabel = findViewById(R.id.locationLabelP);
        locationButton = findViewById(R.id.locationButtonP);
        confirmLocationButton = findViewById(R.id.confirmLocationButtonP);
        searchText = findViewById(R.id.searchTextP);
        searchIcon = findViewById(R.id.searchIconP);
        center_pin = findViewById(R.id.center_pinP);
    }
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == appointmentDateText.getId()){
            if (isMapDisplayed) {
                ...
                new DatePickerDialog(PhysiotherapistVisit.this, appointment_date_listener, myCalendar
            ...
            if (isMapDisplayed) {
                ...
                mTimePicker = new TimePickerDialog(PhysiotherapistVisit.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
                ...
                if (isMapDisplayed) {
                    ...
                    if (radioGroup.getCheckedRadioButtonId() == -1 && appointmentDateText.getText().toString().equals("") && appointmentTimeText.getText().toString().equals("") && conditionText.getText().toString().equals("")) {
                        ...
                        if (radioGroup.getCheckedRadioButtonId() == -1) {
                            Toast.makeText(this, "Please select some complaint.\nIf your complaint is not mentioned, please choose other and write that complaint in condition field below", Toast.LENGTH_SHORT).show();
...
//                            mGoogleMap.addMarker(userMarkerOptions);
    ...
    public void bookAppointment(){
        ...
        final DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("appointments").child("physio_visit").push();
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                reference.child("condition").setValue(condition).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        hideProgressBar();
                        Toast.makeText(PhysiotherapistVisit.this, "Appointment booked", Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(PhysiotherapistVisit.this, "Error.\n"+databaseError, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void getAppointmentCount(){
        final DatabaseReference countReference = FirebaseDatabase.getInstance().getReference().child("appointments").child("physio_visit");
        countReference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                childrenCount = (int) dataSnapshot.getChildrenCount();
                Log.e(TAG, "There are " + childrenCount + " Physiotherapist Visit appointments already");
                if (childrenCount < 10) {
                    childrenCount += 1;
                    appointment_id = "htk-phy-00" + childrenCount;
                } else if (childrenCount >= 10 && childrenCount < 100) {
                    childrenCount += 1;
                    appointment_id = "htk-phy-0" + childrenCount;
                }
                else{
                    childrenCount += 1;
                    appointment_id = "htk-phy-" + childrenCount;
                }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_PDF_CODE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            if (data.getData() != null) {
                ...
                findViewById(R.id.attachment_iconP).setVisibility(View.VISIBLE);
...
//        startActivity(new Intent(PhysiotherapistVisit.this, HomeActivity.class));
//    }
